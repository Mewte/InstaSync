...
vjs.PlayToggle.prototype.onClick = function(){
  if (this.player_.paused()) {
    this.player_.play();
	this.player_.trigger('userPlayed');
  } else {
    this.player_.pause();
	this.player_.trigger('userPaused');
  }
};
...
vjs.SeekBar.prototype.onMouseDown = function(event){
  ...
  this.player_.pause(); //Dont change player state.
};
...
vjs.SeekBar.prototype.onMouseUp = function(event){
  ...
  var time = this.calculateDistance(event) * this.player_.duration();
  if (this.videoWasPlaying) { //player state is perserved now
	this.player_.play();
  }
  this.trigger({type: "userSeeked", time: time});
};
